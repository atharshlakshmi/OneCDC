...
import ActionSuccess from "./pages/ShopperUI/ActionSuccess";
import ProfileHome from "./pages/ProfileUI/ProfileHome";
import ProfileDetails from "./pages/ProfileUI/ProfileDetails";
import ProfileReviews from "./pages/ProfileUI/ProfileReviews";
import ProfileReports from "./pages/ProfileUI/ProfileReports";
import ProfileStores from "./pages/ProfileUI/ProfileStores";
import ProfileFlaggedStores from "./pages/ProfileUI/ProfileFlaggedStores";
import ViewRoute from "./pages/ShopperUI/ViewRoute";
import AddShop from "./pages/OwnerUI/AddShop";
import ManageCatalogue from "./pages/OwnerUI/ManageCatalogue";
